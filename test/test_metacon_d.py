...
from src.graph.global_attack import Metacon_D
...
## Basic Setting
parser.add_argument('--model', type=str, default='metacon_d')
...
parser.add_argument('--vic_coef2', type=float, default=1.0,
                    help='Initial learning rate.')
parser.add_argument('--vic_coef3', type=float, default=1.0,
                    help='Initial learning rate.')
...
# Setup Attack Model
if (args.model == 'metacon_d'):
    model = Metacon_D(model=surrogate, 
