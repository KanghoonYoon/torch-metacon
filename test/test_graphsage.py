...
from src.graph.defense import GraphSAGE
...
parser.add_argument('--pgdepochs', type=int, default=200,
                    help='Number of epochs to train.')
...
def main():
    ...
    print('####################### Graph SAGE ##########################')
    print('=== testing Graph SAGE on clean graph ===')
    ...
    savefile = f'/{args.model}_victim(graphsage).txt'

    print('=== testing Graph SAGE on Evasion attack ===')
    ...
    print('=== testing Graph SAGE on Poisoning attack ===')
